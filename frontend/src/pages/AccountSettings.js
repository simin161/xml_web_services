...
const AccountSettings = () => {
                    ...
                    <div className="row m-l-0 m-r-0">
                        <div className="col-sm-4 bg-c-lite-green user-profile">
                            <div className="card-block text-center text-white">
                                ...
                                <h6 className="f-w-600">dfsf</h6>
                                <p>bvn</p> <i className=" mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16"></i>
                                <p >
  ...
  <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
                                    ...
                                    5
                                </p> <i className=" mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16"></i>
                            </div>
                        </div>
                            ...
                            <div className="card-block">
                                ...
                                <div className="row">
                                    <div className="col-sm-6">
                                        ...
                                        <h6 className="text-muted f-w-400">nbvn</h6>
                                    </div>
                                    <div className="col-sm-6">
                                        <p className="m-b-10 f-w-600">Account type</p>
                                        <h6 className="text-muted f-w-400">5646</h6>
                                    </div>
                                </div>
                                <h6 className="m-b-20 m-t-40 p-b-5 b-b-default f-w-600">Account rank</h6>
                                <div className="row">
                                    <div className="col-sm-6">
                                        <p className="m-b-10 f-w-600">Status</p>
                                        <h6 className="text-muted f-w-400">4565</h6>
                                    </div>
