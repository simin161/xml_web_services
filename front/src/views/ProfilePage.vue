        ...
        <div class="col-lg-8">
            <div class="card right-profile-card">
                ...
                <div class="card-body" style="text-align: left;">
                    <h5 style="text-align: left"><b>{{loggedUser.firstName}} {{loggedUser.lastName}}</b></h5>
           ...
           <div v-if="post.pathToImage !=''" style="text-align: center">
            ...
            <hr>
                 <div >
                   <a @click="loadReactions(post.idPost)" data-bs-toggle="modal" data-bs-target="#reactionModal" style="color: gray; text-decoration: none" target="_blank"  ><b>{{post.numOfReactions}} reactions </b></a> ,
                   <a @click="loadComments(post.idPost)" data-bs-toggle="modal" data-bs-target="#commentsModal"   style="color: gray; text-decoration: none" target="_blank"  ><b>{{post.numOfComments}} comments </b></a> 
...
<!-- Modal -->
<div class="modal fade" id="reactionModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
<!-- Modal -->
<div class="modal fade bd-example-modal-xl" id="commentsModal"  data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel"  aria-hidden="true">
  <div  class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel"></h5>
...
<div class="modal fade" id="staticBackdropFollowing" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h3>{{loggedUser.username}}'s followings</h3>
        <hr>
        <ul class="list-group">
...
<div class="modal fade" id="staticBackdropFollowers" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h3>{{loggedUser.username}}'s followers</h3>
        <hr>
           ...
           console.log(response.data);
            ...
            axios.get(process.env.VUE_APP_BACK + 'experiences/'+this.loggedUser.email+"/")
                 ...
                 .catch(function (error) {
                    ...
                    axios.get(process.env.VUE_APP_BACK + 'getAllUserPosts/'+this.loggedUser.email+"/")
                                      .then((response) => {
      ...
      if(this.comment == ""){
        ...
        return;
         ...
         axios.post(process.env.VUE_APP_BACK + 'comment',{
           postId: this.idPost,
           text: this.comment,
           commentatorsEmail: this.loggedUser.email
         })
                            .then((response) => {
